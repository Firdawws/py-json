...
def main():
    ...
    parser.add_argument('--language', '-l', type=str, default='en', help='Pivot language code')
        ...
        if filename.endswith('.jsonl'):
            ...
            with open(file_path, 'r') as json_file:
                ...
                for record in data:
                    ...
                    # Filter records for the specified pivot language
                    if language_code == pivot_language:
            ...
            output_filename = os.path.splitext(pivot_language + '-' + filename)[0] + '.xlsx'
